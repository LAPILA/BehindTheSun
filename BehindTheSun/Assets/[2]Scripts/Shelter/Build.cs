...
public class Build : MonoBehaviour
{
    ...
    private void GenBuild()
    {
        if (Resource.Instance.GetResourceQuantity("돌") >= 50 &&
            Resource.Instance.GetResourceQuantity("철") >= 50 &&
            Resource.Instance.GetResourceQuantity("금") >= 100) 
            {
    ...
    private void DrillBuild()
    {
        if (Resource.Instance.GetResourceQuantity("돌") >= 200 &&
            Resource.Instance.GetResourceQuantity("철") >= 100 &&
            Resource.Instance.GetResourceQuantity("금") >= 50) {
